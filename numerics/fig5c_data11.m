...
for i = 1:3
  if i == 1
    x = double(native.not_induced);
  elseif i == 2
    x = double(native.induced30um);
  elseif i == 3
    x = double(native.induced30um_later);
  end
...
% save
save([dd 'pi2_native_dkl_exp_cdf2.mat'],'pi2_native_dkl_exp')
