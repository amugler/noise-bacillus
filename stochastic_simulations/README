The folder cpp_code contains c++ code which generate time series data for the different strains and different models.
...
Each file begins with a short description of that code's purpose.
